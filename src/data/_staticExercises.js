...
export const staticExercises = [
  ...
  { id: 'test-time-exercise', name: 'Esercizio di Test (Tempo)', type: 'time', duration: 5, defaultRest: 3 },
  ...
  { id: 'plank', name: 'Plank', series: 3, duration: 60, type: 'time', defaultRest: 45 },
];
